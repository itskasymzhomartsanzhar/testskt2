      ...
      <div className="footer__container">
        <div className="footer__main">
          <div className="footer__brand">
            <h3 className="footer__logo">SKT Agency</h3>
            <p className="footer__tagline">
              Трансформируем бизнес с помощью ИИ и современных технологий
            </p>
          ...
          <div className="footer__links">
            <div className="footer__column">
              <h4 className="footer__column-title">Продукты</h4>
              <ul className="footer__list">
                <li><a href="#" className="footer__link">Веб разработка</a></li>
                <li><a href="#" className="footer__link">Мобильные приложения</a></li>
                <li><a href="#" className="footer__link">ИИ решения</a></li>
                <li><a href="#" className="footer__link">Дизайн систем</a></li>
              </ul>
            </div>
            ...
            <div className="footer__column">
              ...
              <ul className="footer__list">
                <li><a href="#" className="footer__link">Документация</a></li>
                <li><a href="#" className="footer__link">Кейсы</a></li>
        ...
        <div className="footer__bottom">
          <p className="footer__copyright">
            © {currentYear} SKT Agency. Все права защищены.
          </p>
